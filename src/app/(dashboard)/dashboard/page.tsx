...
export default function Dashboard() {
  ...
  return (
    <section className="flex flex-col gap-6 pt-[32px]">
      ...
      <section className="grid min-h-[295px] items-center gap-8 overflow-hidden rounded-[24px] border border-[#E8E8E8] bg-[linear-gradient(120deg,#FFEDE0_15%,#FED4CC_60%,#FF8D6D_100%)] px-4 py-8 md:grid-cols-[minmax(0,1fr)_minmax(320px,0.75fr)] md:px-10 md:pt-10 lg:px-[56px] lg:py-[48px]">
        <div className="max-w-[620px]">
          ...
          <h1 className="py-6 font-jakarta text-[28px] font-bold leading-[34px] tracking-normal text-[#6B2C1A] text-balance md:max-w-[400px] md:text-[34px] md:leading-[36px]">
          ...
          <div className="flex flex-col items-center gap-3 pt-6 min-[430px]:flex-row min-[430px]:items-center">
            <Link
              href="/create-badges"
              className="whitespace-nowrap rounded-full bg-[#6B2C1A] px-6 py-[14px] text-center text-[clamp(12px,1.5vw,14px)] font-semibold text-white"
            >
            ...
            <Link
              href="/templates"
              className="whitespace-nowrap rounded-full bg-white px-6 py-[14px] text-center text-[clamp(12px,1.5vw,14px)] font-semibold text-[#333333]"
            >
              Browse templates
            </Link>
          </div>
