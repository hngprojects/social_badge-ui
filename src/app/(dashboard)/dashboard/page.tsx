import BrowseTemplate from "./components/browse-templates";
 ...
 export default function Dashboard() {
   ...
   return (
     <section className="flex flex-col gap-6 pt-[32px] p-5">
       <header>
       ...
       <section className="flex flex-col md:flex-row min-h-75 rounded-[12px] border items-center justify-center border-[#E8E8E8] center px-[24px] md:px-[56px] gap-[24px] rounded-[24px] bg-[linear-gradient(120deg,#FFEDE0_15%,#FED4CC_60%,#FF8D6D_100%)] pt-[40px] md:pt-[56px] pb-[40px] md:pb-[52px]">
         <div className="flex-1">
           ...
           <h1 className="font-bold text-[#6B2C1A] text-[28px] md:text-[36px] py-[12px] leading-[34px] md:leading-[40px]">
           ...
           <div className="pt-[24px] flex flex-wrap items-center gap-[12px]">
             <Link
               href="/create-badges"
