...
import { items } from '@/app/(marketing)/constants/wailtlist';
      ...
      <div className="px-4">
        ...
        <main className="relative z-10 flex flex-col items-center text-center max-w-4xl w-full">
          ...
          <p className="text-base md:text-[18px] text-[#121217] max-w-[340px] md:max-w-xl mb-8 leading-relaxed px-4">
            Turn your attendees into promoters with personalized badges they can generate and post
            in seconds, Let your community do the marketing for you.
          </p>
          ...
          {items.map((item, index) => (
            <Fragment key={index}>
              ...
              >
                ...
                />
                <h2 className="text-[#E5E7EB] text-base md:text-lg font-semibold">{item.title}</h2>
              </div>
