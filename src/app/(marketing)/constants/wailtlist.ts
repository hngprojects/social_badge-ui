...
import { BenefitSectionType } from "../types/waitlist";
...
export const stepsData: StepDataType[] = [
    {
        ...
        description: "Upload your brand assets or choose from our stunning minimalist templates.",
        iconSrc: "/assets/waitlist/waitlist-step1.png",
    },
    {
        stepNumber: 2,
        title: "Share it with your audience",
        description: "Distribute your unique portal link via email, social, or embed it on your site.",
        iconSrc: "/assets/waitlist/waitlist-step2.png",
    },
    {
        stepNumber: 3,
        title: "Participants generate & share",
        description: "They upload a photo, generate their badge, and share it instantly to their networks.",
