		...
		<LegalLayout
			...
			summary={
				<p>
					...
					They help websites remember things between page loads — like whether
					you are signed in.
				</p>
			}
		>
			<section id="acceptance" className="scroll-mt-32 flex flex-col gap-4">
				...
				<p>
					Flare Tag sets one cookie. That is it. We do not use advertising
					cookies, analytics cookies, or any form of behavioural tracking.
				</p>
			</section>
				...
				<div className="flex flex-col gap-4">
					<p>
						<strong className="font-semibold text-foreground">
							What this cookie contains:
						</strong>{" "}
						The refresh_token cookie holds a secure token that identifies your
						session. It contains only your internal account identifier, an
						expiry timestamp, and a unique token ID. It does not contain your
						name, email address, or any other personal information.
					</p>
							...
							<table className="w-full text-sm border-collapse">
								...
								<tbody>
									...
									<tr className="border-b border-border/50">
										...
										<td className="py-2">
											Lax — protected against cross-site request forgery
										</td>
									</tr>
									<tr>
					...
					<p>
						<strong className="font-semibold text-foreground">Type:</strong>{" "}
						Strictly necessary
					</p>
					...
					<p>
						...
						This cookie is required for you to stay signed in. Disabling it
						means you will be logged out every time you reload the page.
					</p>
				</div>
			</section>
			...
			<section id="accounts" className="scroll-mt-32 flex flex-col gap-4">
				...
				<p>
					...
					You access Flare Tag without signing in, and nothing is stored in your
					browser.
				</p>
			</section>
			...
			<section id="acceptable-use" className="scroll-mt-32 flex flex-col gap-4">
				...
				<p>
					No. The one cookie we set is strictly necessary for the platform to
					function. Under applicable data protection regulations, strictly
					necessary cookies do not require a consent banner or prior approval.
				</p>
			</section>
			...
			<section id="payments" className="scroll-mt-32 flex flex-col gap-4">
				...
				<p>
					Flare Tag works with the following third-party services that may
					process your data as part of delivering the platform. These are
					processors only — they do not receive your data for their own
					purposes.
				</p>
						...
						<tbody>
							<tr className="border-b border-border/50">
								...
								<td className="py-3 align-top">
									To sign you in via Google OAuth
								</td>
							</tr>
							<tr className="border-b border-border/50">
								<td className="py-3 pr-6 align-top">Cloudinary</td>
								<td className="py-3 pr-6 align-top">
									Logos you upload, photos used in badge generation, generated
									badge images
								</td>
				...
				<p>
					No data is shared with advertising networks, data brokers, or
					analytics platforms.
				</p>
			</section>
			...
			<section id="liability" className="scroll-mt-32 flex flex-col gap-4">
				...
				<ul className="list-disc pl-5 flex flex-col gap-2 marker:text-muted-foreground">
					<li>
						<strong className="font-semibold text-foreground">Chrome:</strong>{" "}
						Settings &rarr; Privacy and Security &rarr; Cookies and other site
						data
					</li>
					<li>
						<strong className="font-semibold text-foreground">Safari:</strong>{" "}
						Settings &rarr; Safari &rarr; Privacy &amp; Security
					</li>
					<li>
						<strong className="font-semibold text-foreground">Firefox:</strong>{" "}
						Settings &rarr; Privacy &amp; Security &rarr; Cookies and Site Data
					</li>
					<li>
						<strong className="font-semibold text-foreground">Edge:</strong>{" "}
						Settings &rarr; Cookies and site permissions
					</li>
				</ul>
				<p>
					Note that deleting the refresh_token cookie will sign you out of Flare
					Tag.
				</p>
			</section>
			...
			<section id="governing-law" className="scroll-mt-32 flex flex-col gap-4">
				...
				<p>
					If our cookie use changes — for example if we add new features that
					introduce new cookies — we will update this page and revise the date
					at the top before those changes go live.
				</p>
			</section>
