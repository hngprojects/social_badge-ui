	...
	return (
		...
		>
			<section id="acceptance" className="scroll-mt-32 flex flex-col gap-4">
				...
				<p>
					Social Badge sets one cookie. That is it. We do not use advertising
			...
			<section id="accounts" className="scroll-mt-32 flex flex-col gap-4">
				...
				<p>
					...
					You access Social Badge without signing in, and nothing is stored in
					your browser.
				</p>
			</section>
			...
			<section id="payments" className="scroll-mt-32 flex flex-col gap-4">
				...
				<p>
					Social Badge works with the following third-party services that may
			...
			<section id="liability" className="scroll-mt-32 flex flex-col gap-4">
				...
				<p>
					Note that deleting the refresh_token cookie will sign you out of
					Social Badge.
				</p>
			</section>
