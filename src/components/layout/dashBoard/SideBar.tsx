  ...
  return (
    ...
    >
      <div className="flex h-full flex-col justify-between gap-[30px]">
        <div>
          <header
            className={`flex ${!expanded && "flex-col"} mt-3 mb-2 items-center justify-between gap-6 whitespace-nowrap p-4 pt-[18px] pb-6 text-[#231F20]`}
          >
        ...
        <div className="px-4">
          <div
            className={`flex flex-col gap-3 border-t border-[#00000014]/60 pt-4 ${
